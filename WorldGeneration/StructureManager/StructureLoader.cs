...
namespace CrystalMoon.WorldGeneration.StructureManager
{
    /// <summary>
    ...
    public static class StructureLoader
    {
        ...
        static Mod Mod = ModContent.GetInstance<CrystalMoon>();
    ...
    {
        public override string Texture => "CrystalMoon/WorldGeneration/StructureManager/Modelizer"; //I do not do spriting
        public override void SetDefaults()
        {
            Item.CloneDefaults(ItemID.MagicConch);
            Item.useTime = Item.useAnimation = 15;
