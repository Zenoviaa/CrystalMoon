...
namespace CrystalMoon.Visual.Dusts
{
    public class MothlightDust : ModDust
    {
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new MagicMothlightMaskingArmorShaderData(new Ref<Effect>(CrystalMoon.Instance.Assets.Request<Effect>("Assets/Effects/MagicMothlightMasking", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "PixelPass");
        }
