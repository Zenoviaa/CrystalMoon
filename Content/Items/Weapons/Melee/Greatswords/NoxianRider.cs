...
namespace CrystalMoon.Content.Items.Weapons.Melee.Greatswords
{
    ...
    public class NKRMoped : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            CrystalMoonFXUtil.ShakeCamera(Projectile.Center, 1024, 16);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (!_npcSucker.HasSuckerTarget(target))
            {
                ...
                CrystalMoonFXUtil.PunchCamera(target.Center, Projectile.velocity.SafeNormalize(Vector2.Zero) * 8, 0.5f, 2, 30);
                _npcSucker.AddNPCSuckerTarget(Projectile.Center, target);
            }
        }
