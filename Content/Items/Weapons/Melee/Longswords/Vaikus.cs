...
namespace CrystalMoon.Content.Items.Weapons.Melee.Longswords
{
    ...
    {
        public override string Texture => "CrystalMoon/Content/Items/Weapons/Melee/Longswords/Vaikus";
        ...
        internal class VaikusProj : ModProjectile
        {
            ...
            public override void OnKill(int timeLeft)
            {
                 ...
                 SoundEngine.PlaySound(spearHit, Projectile.position);          
                  ...
                  CrystalMoonFXUtil.ShakeCamera(Projectile.Center, 1024, 8f);
