...
namespace CrystalMoon.Content.Items.Weapons.Magic.Tomes
{
    ...
    internal class MothlightStarTome : BaseMagicTomeProjectile
    {
        ...
        public override string Texture => "CrystalMoon/Content/Items/Weapons/Magic/Tomes/MothlightStar";
        public override void SetDefaults()
        {
            base.SetDefaults();
            //How often it shoots
        ...
        IDrawMaskShader
    {
        ...
        public BaseShader GetMaskDrawShader()
        {
            //Use the defaults
        ...
        public void DrawMask(SpriteBatch spriteBatch)
        {
            ...
            trailShader.TrailingTexture = TextureRegistry.GlowTrailNoBlack;
            trailShader.SecondaryTrailingTexture = TextureRegistry.GlowTrailNoBlack;
            trailShader.TertiaryTrailingTexture = TextureRegistry.GlowTrailNoBlack;
