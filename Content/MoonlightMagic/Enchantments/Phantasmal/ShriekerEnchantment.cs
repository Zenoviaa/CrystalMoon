...
using CrystalMoon.Content.MoonlightMagic.Enchantments.Hex;
    ...
    internal class ShriekerEnchantmentExplosion : BaseShriekExplosionProjectile
    {
        ...
        private float WidthFunction(float completionRatio)
        {
            ...
            else
            {
                ...
                float trailWidth = MathHelper.Lerp(0, width, Easing.OutCirc(completionRatio));
                return MathHelper.Lerp(circleWidth, trailWidth, Easing.OutExpo(completionRatio)) * Easing.SpikeOutCirc(Progress);
                */
            }
        }
