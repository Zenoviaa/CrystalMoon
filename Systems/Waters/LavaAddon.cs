...
namespace CrystalMoon.Systems.Waters
{
    internal class LavaAddon : WaterAddon
    {
        ...
        private static void RenderFront(SpriteBatch spriteBatch)
        {
            ...
            Texture2D tex2 = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/LavaDepths", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        ...
        {
            Effect effect = Filters.Scene["CrystalMoon:Lava"].GetShader().Shader;
