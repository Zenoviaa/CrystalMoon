...
namespace CrystalMoon.Systems.Skies
{
    public class DesertSky : CustomSky
    {
        ...
        {
            var texture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/Clouds5");
            var colorMapTexture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/ColorMapYellow");
