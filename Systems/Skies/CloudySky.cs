...
namespace CrystalMoon.Systems.Skies
{
    public class CloudySky : CustomSky
    {
        ...
        {
            var texture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/Clouds3");
            var cloudTexture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/ColorMap");
        ...
        {
            var texture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/Clouds2");
            var cloudTexture = ModContent.Request<Texture2D>("CrystalMoon/Assets/NoiseTextures/ColorMap");
            MiscShaderData eff = ShaderRegistry.CloudsShader;
            if (!Main.dayTime)
                eff = ShaderRegistry.NightCloudsShader;
