using CrystalMoon.WorldGeneration.BaseEdits;
...
namespace CrystalMoon.Tiles.RainforestTiles
{
    internal class RainforestTreeSapling : ModTile
    {
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            if (!CrystalMoonWorldBase.IsGround(i - 1, j + 3, 4))
                return;
            ...
            CrystalMoonWorldBase.PlaceRaintrees(i, j + 3, height);
        }
    ...
    internal class RainforestTree : ModTile
    {
        ...
        {
            Vector2 pos2 = (new Vector2(i + 1, j) + Systems.TileSystems.MultitileHelper.TileAdj) * 16;
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (shouldDraw && right && !up && down)
            {
                ...
                Vector2 pos = (new Vector2(i + 1, j) + Systems.TileSystems.MultitileHelper.TileAdj) * 16;
